...
#endif
#if !(defined(TARGET_OS_UEFI) || defined(__coverity_undefine_TARGET_OS_UEFI))
...
#endif
#if !(defined(_HAS_BUILTIN_AVAILABLE_FEATS) || defined(__coverity_undefine__HAS_BUILTIN_AVAILABLE_FEATS))
...
#endif
#if !(defined(__cpp_variadic_friend) || defined(__coverity_undefine___cpp_variadic_friend))
