...
#if __COVERITY__
#if !defined(COVERITY_COMPAT_2bee6e5cb63127a622c434efa2b021d1)
#define COVERITY_COMPAT_2bee6e5cb63127a622c434efa2b021d1

/*
  Copyright 2025 Black Duck Software, Inc. All rights reserved.
...
typedef long long __cov_int64_t;
typedef unsigned long long __cov_uint64_t;
...
#endif /* } (__coverity_clang_major__ < 14) */
...
#endif /* ( __cov_clang_version_ge(3, 7) || __cov_xcode_version_ge(7, 0)) */
...
/* Xcode 16.0 / Apple Clang 16 (Clang 17.0) */
#if (__coverity_assume_xcode__ ) /* { */
extern void
__coverity__builtin_verbose_trap(
    const char *  __a);
#define __builtin_verbose_trap(P0) \
    __coverity__builtin_verbose_trap((P0))
#endif // Apple Clang 16.0
#endif /* Clang 17 */
...
__coverity__builtin_sme_svld1_hor_vnum_za128(
    const __cov_uint64_t __a,
    unsigned int __b,
    const __cov_uint64_t __c,
    __SVBool_t __d,
    const void *  __e,
    __cov_int64_t __f);
...
#if (__coverity_assume_android__ && __cov_clang_version_ge(18, 0)) /* { */
/* Added in android r27 (based on clang 18.0), renamed by clang 18.1 */

#define __builtin_sve_svcreate2_b8 __builtin_sve_svcreate2_b
#define __builtin_sve_svcreate4_b8 __builtin_sve_svcreate4_b

#define __builtin_sve_svdot_f32_f16_f16      __builtin_sve_svdot_f32_f16
#define __builtin_sve_svdot_lane_f32_f16_f16 __builtin_sve_svdot_lane_f32_f16
#define __builtin_sve_svdot_lane_s32_s16_s16 __builtin_sve_svdot_lane_s32_s16
#define __builtin_sve_svdot_lane_u32_u16_u16 __builtin_sve_svdot_lane_u32_u16
#define __builtin_sve_svdot_s32_s16_s16      __builtin_sve_svdot_s32_s16
#define __builtin_sve_svdot_u32_u16_u16      __builtin_sve_svdot_u32_u16

#define __builtin_sve_svextq_lane_bf16 __builtin_sve_svextq_bf16
#define __builtin_sve_svextq_lane_f16  __builtin_sve_svextq_f16
#define __builtin_sve_svextq_lane_f32  __builtin_sve_svextq_f32
#define __builtin_sve_svextq_lane_f64  __builtin_sve_svextq_f64

#define __builtin_sve_svextq_lane_s16  __builtin_sve_svextq_s16
#define __builtin_sve_svextq_lane_s32  __builtin_sve_svextq_s32
#define __builtin_sve_svextq_lane_s64  __builtin_sve_svextq_s64
#define __builtin_sve_svextq_lane_s8   __builtin_sve_svextq_s8

#define __builtin_sve_svextq_lane_u16  __builtin_sve_svextq_u16
#define __builtin_sve_svextq_lane_u32  __builtin_sve_svextq_u32
#define __builtin_sve_svextq_lane_u64  __builtin_sve_svextq_u64
#define __builtin_sve_svextq_lane_u8   __builtin_sve_svextq_u8

#define __builtin_sve_svget2_b8 __builtin_sve_svget2_b
#define __builtin_sve_svget4_b8 __builtin_sve_svget4_b
#define __builtin_sve_svset2_b8 __builtin_sve_svset2_b
#define __builtin_sve_svset4_b8 __builtin_sve_svset4_b

#define __builtin_sve_svst1udq_f64 __builtin_sve_svst1dq_f64
#define __builtin_sve_svst1udq_s64 __builtin_sve_svst1dq_s64
#define __builtin_sve_svst1udq_u64 __builtin_sve_svst1dq_u64

#define __builtin_sve_svst1udq_vnum_f64 __builtin_sve_svst1dq_vnum_f64
#define __builtin_sve_svst1udq_vnum_s64 __builtin_sve_svst1dq_vnum_s64
#define __builtin_sve_svst1udq_vnum_u64 __builtin_sve_svst1dq_vnum_u64

#define __builtin_sve_svst1uwq_f32 __builtin_sve_svst1wq_f32
#define __builtin_sve_svst1uwq_s32 __builtin_sve_svst1wq_s32
#define __builtin_sve_svst1uwq_u32 __builtin_sve_svst1wq_u32

#define __builtin_sve_svst1uwq_vnum_f32 __builtin_sve_svst1wq_vnum_f32
#define __builtin_sve_svst1uwq_vnum_s32 __builtin_sve_svst1wq_vnum_s32
#define __builtin_sve_svst1uwq_vnum_u32 __builtin_sve_svst1wq_vnum_u32
...
#if (__cov_clang_version_lt(19, 1)) /* { */

/* Signatures changed in Clang 19.1 { */
extern void
__coverity__builtin_amdgcn_fence(
    unsigned int __a,
    const char * __b);
#define __builtin_amdgcn_fence(P0, P1) \
    __coverity__builtin_amdgcn_fence((P0), (P1))

extern void
__coverity__builtin_arm_get_sme_state(
    unsigned long int * __a,
    unsigned long int * __b);
#define __builtin_arm_get_sme_state(P0, P1) \
    __coverity__builtin_arm_get_sme_state((P0), (P1))

/* __builtin_neon_vqrshrund_n_s64(UiWiIi) vs. (iWiIi) differs only in return type: Not generated */
/* __builtin_neon_vqrshrunh_n_s16(UcsIi) vs. (ScsIi) differs only in return type: Not generated */
/* __builtin_neon_vqrshruns_n_s32(UsiIi) vs. (siIi) differs only in return type: Not generated */
/* __builtin_neon_vqshrund_n_s64(UiWiIi) vs. (iWiIi) differs only in return type: Not generated */
/* __builtin_neon_vqshrunh_n_s16(UcsIi) vs. (ScsIi) differs only in return type: Not generated */
/* __builtin_neon_vqshruns_n_s32(UsiIi) vs. (siIi) differs only in return type: Not generated */
/* __builtin_preserve_type_info(LUi.) vs. (Ui.) differs only in return type: Not generated */
/* __builtin_sadd_overflow(biCiCi*) vs. (bSiCSiCSi*) differs only in signed int vs int: Not generated */
/* __builtin_saddl_overflow(bLiCLiCLi*) vs. (bSLiCSLiCSLi*) differs only in signed int vs int: Not generated */
/* __builtin_saddll_overflow(bLLiCLLiCLLi*) vs. (bSLLiCSLLiCSLLi*) differs only in signed int vs int: Not generated */
extern void
__coverity__builtin_sme_svzero_za(void);
#define __builtin_sme_svzero_za() \
    __coverity__builtin_sme_svzero_za()

/* __builtin_smul_overflow(biCiCi*) vs. (bSiCSiCSi*) differs only in signed int vs int: Not generated */
/* __builtin_smull_overflow(bLiCLiCLi*) vs. (bSLiCSLiCSLi*) differs only in signed int vs int: Not generated */
/* __builtin_smulll_overflow(bLLiCLLiCLLi*) vs. (bSLLiCSLLiCSLLi*) differs only in signed int vs int: Not generated */
/* __builtin_ssub_overflow(biCiCi*) vs. (bSiCSiCSi*) differs only in signed int vs int: Not generated */
/* __builtin_ssubl_overflow(bLiCLiCLi*) vs. (bSLiCSLiCSLi*) differs only in signed int vs int: Not generated */
/* __builtin_ssubll_overflow(bLLiCLLiCLLi*) vs. (bSLLiCSLLiCSLLi*) differs only in signed int vs int: Not generated */
/* __prefetch(vvC*) vs. (vv*) differs only in const/volatile/restrict qualifiers: Not generated */
/* fprintf(iP*RcC*R.) vs. (iP*cC*.) differs only in const/volatile/restrict qualifiers: Not generated */
/* savectx(iSJ) vs. (iJ) differs only in signed int vs int: Not generated */
/* snprintf(ic*RzcC*R.) vs. (ic*zcC*.) differs only in const/volatile/restrict qualifiers: Not generated */
/* sprintf(ic*RcC*R.) vs. (ic*cC*.) differs only in const/volatile/restrict qualifiers: Not generated */
/* vfprintf(iP*RcC*Ra) vs. (iP*cC*a) differs only in const/volatile/restrict qualifiers: Not generated */
/* vprintf(icC*Ra) vs. (icC*a) differs only in const/volatile/restrict qualifiers: Not generated */
/* vsnprintf(ic*RzcC*Ra) vs. (ic*zcC*a) differs only in const/volatile/restrict qualifiers: Not generated */
/* vsprintf(ic*RcC*Ra) vs. (ic*cC*a) differs only in const/volatile/restrict qualifiers: Not generated */
/* } Signatures Changed in Clang 19.1 */

/* Signatures Removed in Clang 19.1 { */
extern int
__coverity__builtin_amdgcn_global_load_tr_i32(
    int * __a);
#define __builtin_amdgcn_global_load_tr_i32(P0) \
    __coverity__builtin_amdgcn_global_load_tr_i32((P0))

extern int __attribute__((vector_size(8)))
__coverity__builtin_amdgcn_global_load_tr_v2i32(
    int __attribute__((vector_size(8))) * __a);
#define __builtin_amdgcn_global_load_tr_v2i32(P0) \
    __coverity__builtin_amdgcn_global_load_tr_v2i32((P0))

extern short __attribute__((vector_size(8)))
__coverity__builtin_amdgcn_global_load_tr_v4f16(
    short __attribute__((vector_size(8))) * __a);
#define __builtin_amdgcn_global_load_tr_v4f16(P0) \
    __coverity__builtin_amdgcn_global_load_tr_v4f16((P0))

extern short __attribute__((vector_size(8)))
__coverity__builtin_amdgcn_global_load_tr_v4i16(
    short __attribute__((vector_size(8))) * __a);
#define __builtin_amdgcn_global_load_tr_v4i16(P0) \
    __coverity__builtin_amdgcn_global_load_tr_v4i16((P0))

extern short __attribute__((vector_size(16)))
__coverity__builtin_amdgcn_global_load_tr_v8f16(
    short __attribute__((vector_size(16))) * __a);
#define __builtin_amdgcn_global_load_tr_v8f16(P0) \
    __coverity__builtin_amdgcn_global_load_tr_v8f16((P0))

extern short __attribute__((vector_size(16)))
__coverity__builtin_amdgcn_global_load_tr_v8i16(
    short __attribute__((vector_size(16))) * __a);
#define __builtin_amdgcn_global_load_tr_v8i16(P0) \
    __coverity__builtin_amdgcn_global_load_tr_v8i16((P0))

extern double __attribute__((vector_size(64)))
__coverity__builtin_ia32_exp2pd_mask(
    double __attribute__((vector_size(64))) __a,
    double __attribute__((vector_size(64))) __b,
    unsigned char __c,
    const int __d);
#define __builtin_ia32_exp2pd_mask(P0, P1, P2, P3) \
    __coverity__builtin_ia32_exp2pd_mask((P0), (P1), (P2), (P3))

extern float __attribute__((vector_size(64)))
__coverity__builtin_ia32_exp2ps_mask(
    float __attribute__((vector_size(64))) __a,
    float __attribute__((vector_size(64))) __b,
    unsigned short __c,
    const int __d);
#define __builtin_ia32_exp2ps_mask(P0, P1, P2, P3) \
    __coverity__builtin_ia32_exp2ps_mask((P0), (P1), (P2), (P3))

extern void
__coverity__builtin_ia32_femms(void);
#define __builtin_ia32_femms() \
    __coverity__builtin_ia32_femms()
...
extern char __attribute__((vector_size(8)))
__coverity__builtin_ia32_pavgusb(
    char __attribute__((vector_size(8))) __a,
    char __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pavgusb(P0, P1) \
    __coverity__builtin_ia32_pavgusb((P0), (P1))

extern int __attribute__((vector_size(8)))
__coverity__builtin_ia32_pf2id(
    float __attribute__((vector_size(8))) __a);
#define __builtin_ia32_pf2id(P0) \
    __coverity__builtin_ia32_pf2id((P0))

extern int __attribute__((vector_size(8)))
__coverity__builtin_ia32_pf2iw(
    float __attribute__((vector_size(8))) __a);
#define __builtin_ia32_pf2iw(P0) \
    __coverity__builtin_ia32_pf2iw((P0))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfacc(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfacc(P0, P1) \
    __coverity__builtin_ia32_pfacc((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfadd(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfadd(P0, P1) \
    __coverity__builtin_ia32_pfadd((P0), (P1))

extern int __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfcmpeq(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfcmpeq(P0, P1) \
    __coverity__builtin_ia32_pfcmpeq((P0), (P1))

extern int __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfcmpge(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfcmpge(P0, P1) \
    __coverity__builtin_ia32_pfcmpge((P0), (P1))

extern int __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfcmpgt(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfcmpgt(P0, P1) \
    __coverity__builtin_ia32_pfcmpgt((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfmax(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfmax(P0, P1) \
    __coverity__builtin_ia32_pfmax((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfmin(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfmin(P0, P1) \
    __coverity__builtin_ia32_pfmin((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfmul(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfmul(P0, P1) \
    __coverity__builtin_ia32_pfmul((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfnacc(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfnacc(P0, P1) \
    __coverity__builtin_ia32_pfnacc((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfpnacc(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfpnacc(P0, P1) \
    __coverity__builtin_ia32_pfpnacc((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfrcp(
    float __attribute__((vector_size(8))) __a);
#define __builtin_ia32_pfrcp(P0) \
    __coverity__builtin_ia32_pfrcp((P0))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfrcpit1(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfrcpit1(P0, P1) \
    __coverity__builtin_ia32_pfrcpit1((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfrcpit2(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfrcpit2(P0, P1) \
    __coverity__builtin_ia32_pfrcpit2((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfrsqit1(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfrsqit1(P0, P1) \
    __coverity__builtin_ia32_pfrsqit1((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfrsqrt(
    float __attribute__((vector_size(8))) __a);
#define __builtin_ia32_pfrsqrt(P0) \
    __coverity__builtin_ia32_pfrsqrt((P0))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfsub(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfsub(P0, P1) \
    __coverity__builtin_ia32_pfsub((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pfsubr(
    float __attribute__((vector_size(8))) __a,
    float __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pfsubr(P0, P1) \
    __coverity__builtin_ia32_pfsubr((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pi2fd(
    int __attribute__((vector_size(8))) __a);
#define __builtin_ia32_pi2fd(P0) \
    __coverity__builtin_ia32_pi2fd((P0))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pi2fw(
    int __attribute__((vector_size(8))) __a);
#define __builtin_ia32_pi2fw(P0) \
    __coverity__builtin_ia32_pi2fw((P0))

extern short __attribute__((vector_size(8)))
__coverity__builtin_ia32_pmulhrw(
    short __attribute__((vector_size(8))) __a,
    short __attribute__((vector_size(8))) __b);
#define __builtin_ia32_pmulhrw(P0, P1) \
    __coverity__builtin_ia32_pmulhrw((P0), (P1))

extern float __attribute__((vector_size(8)))
__coverity__builtin_ia32_pswapdsf(
    float __attribute__((vector_size(8))) __a);
#define __builtin_ia32_pswapdsf(P0) \
    __coverity__builtin_ia32_pswapdsf((P0))

extern int __attribute__((vector_size(8)))
__coverity__builtin_ia32_pswapdsi(
    int __attribute__((vector_size(8))) __a);
#define __builtin_ia32_pswapdsi(P0) \
    __coverity__builtin_ia32_pswapdsi((P0))
...
extern double __attribute__((vector_size(16)))
__coverity__builtin_ia32_rcp28sd_round_mask(
    double __attribute__((vector_size(16))) __a,
    double __attribute__((vector_size(16))) __b,
    double __attribute__((vector_size(16))) __c,
    unsigned char __d,
    const int __e);
#define __builtin_ia32_rcp28sd_round_mask(P0, P1, P2, P3, P4) \
    __coverity__builtin_ia32_rcp28sd_round_mask((P0), (P1), (P2), (P3), (P4))

extern float __attribute__((vector_size(16)))
__coverity__builtin_ia32_rcp28ss_round_mask(
    float __attribute__((vector_size(16))) __a,
    float __attribute__((vector_size(16))) __b,
    float __attribute__((vector_size(16))) __c,
    unsigned char __d,
    const int __e);
#define __builtin_ia32_rcp28ss_round_mask(P0, P1, P2, P3, P4) \
    __coverity__builtin_ia32_rcp28ss_round_mask((P0), (P1), (P2), (P3), (P4))
...
extern double __attribute__((vector_size(16)))
__coverity__builtin_ia32_rsqrt28sd_round_mask(
    double __attribute__((vector_size(16))) __a,
    double __attribute__((vector_size(16))) __b,
    double __attribute__((vector_size(16))) __c,
    unsigned char __d,
    const int __e);
#define __builtin_ia32_rsqrt28sd_round_mask(P0, P1, P2, P3, P4) \
    __coverity__builtin_ia32_rsqrt28sd_round_mask((P0), (P1), (P2), (P3), (P4))

extern float __attribute__((vector_size(16)))
__coverity__builtin_ia32_rsqrt28ss_round_mask(
    float __attribute__((vector_size(16))) __a,
    float __attribute__((vector_size(16))) __b,
    float __attribute__((vector_size(16))) __c,
    unsigned char __d,
    const int __e);
#define __builtin_ia32_rsqrt28ss_round_mask(P0, P1, P2, P3, P4) \
    __coverity__builtin_ia32_rsqrt28ss_round_mask((P0), (P1), (P2), (P3), (P4))
...
extern signed char __attribute__((vector_size(8)))
__coverity__builtin_neon_vbsl_f16(
    signed char __attribute__((vector_size(8))) __a,
    signed char __attribute__((vector_size(8))) __b,
    signed char __attribute__((vector_size(8))) __c,
    int __d);
#define __builtin_neon_vbsl_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vbsl_f16((P0), (P1), (P2), (P3))

extern signed char __attribute__((vector_size(16)))
__coverity__builtin_neon_vbslq_f16(
    signed char __attribute__((vector_size(16))) __a,
    signed char __attribute__((vector_size(16))) __b,
    signed char __attribute__((vector_size(16))) __c,
    int __d);
#define __builtin_neon_vbslq_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vbslq_f16((P0), (P1), (P2), (P3))

extern signed char __attribute__((vector_size(8)))
__coverity__builtin_neon_vext_f16(
    signed char __attribute__((vector_size(8))) __a,
    signed char __attribute__((vector_size(8))) __b,
    const int __c,
    int __d);
#define __builtin_neon_vext_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vext_f16((P0), (P1), (P2), (P3))

extern signed char __attribute__((vector_size(16)))
__coverity__builtin_neon_vextq_f16(
    signed char __attribute__((vector_size(16))) __a,
    signed char __attribute__((vector_size(16))) __b,
    const int __c,
    int __d);
#define __builtin_neon_vextq_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vextq_f16((P0), (P1), (P2), (P3))

extern void
__coverity__builtin_neon_vtrn_f16(
    void * __a,
    signed char __attribute__((vector_size(8))) __b,
    signed char __attribute__((vector_size(8))) __c,
    int __d);
#define __builtin_neon_vtrn_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vtrn_f16((P0), (P1), (P2), (P3))

extern void
__coverity__builtin_neon_vtrnq_f16(
    void * __a,
    signed char __attribute__((vector_size(16))) __b,
    signed char __attribute__((vector_size(16))) __c,
    int __d);
#define __builtin_neon_vtrnq_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vtrnq_f16((P0), (P1), (P2), (P3))

extern void
__coverity__builtin_neon_vuzp_f16(
    void * __a,
    signed char __attribute__((vector_size(8))) __b,
    signed char __attribute__((vector_size(8))) __c,
    int __d);
#define __builtin_neon_vuzp_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vuzp_f16((P0), (P1), (P2), (P3))

extern void
__coverity__builtin_neon_vuzpq_f16(
    void * __a,
    signed char __attribute__((vector_size(16))) __b,
    signed char __attribute__((vector_size(16))) __c,
    int __d);
#define __builtin_neon_vuzpq_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vuzpq_f16((P0), (P1), (P2), (P3))

extern void
__coverity__builtin_neon_vzip_f16(
    void * __a,
    signed char __attribute__((vector_size(8))) __b,
    signed char __attribute__((vector_size(8))) __c,
    int __d);
#define __builtin_neon_vzip_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vzip_f16((P0), (P1), (P2), (P3))

extern void
__coverity__builtin_neon_vzipq_f16(
    void * __a,
    signed char __attribute__((vector_size(16))) __b,
    signed char __attribute__((vector_size(16))) __c,
    int __d);
#define __builtin_neon_vzipq_f16(P0, P1, P2, P3) \
    __coverity__builtin_neon_vzipq_f16((P0), (P1), (P2), (P3))

/* __builtin_rvv_sf_vc_i_se_u16m1 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u16m2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u16m4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u16m8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u16mf2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u16mf4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u32m1 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u32m2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u32m4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u32m8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u32mf2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u64m1 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u64m2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u64m4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u64m8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u8m1 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u8m2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u8m4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u8m8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u8mf2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u8mf4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_i_se_u8mf8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u16m1 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u16m2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u16m4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u16m8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u16mf2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u16mf4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u32m1 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u32m2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u32m4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u32m8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u32mf2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u64m1 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u64m2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u64m4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u64m8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u8m1 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u8m2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u8m4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u8m8 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u8mf2 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u8mf4 missing type information: Not generated */
/* __builtin_rvv_sf_vc_x_se_u8mf8 missing type information: Not generated */
/* __builtin_rvv_vcpopv_v missing type information: Not generated */
/* __builtin_rvv_vcpopv_v_m missing type information: Not generated */
/* __builtin_rvv_vcpopv_v_mu missing type information: Not generated */
/* __builtin_rvv_vcpopv_v_tu missing type information: Not generated */
/* __builtin_rvv_vcpopv_v_tum missing type information: Not generated */
/* __builtin_rvv_vcpopv_v_tumu missing type information: Not generated */
/* } Signatures Removed in Clang 19.1 */
...
#endif /* COVERITY_COMPAT_2bee6e5cb63127a622c434efa2b021d1 */
#endif /* __COVERITY__ */
